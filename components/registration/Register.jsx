                ...
                <div className="flex flex-col md:ml-12 mt-6 items-center w-full gap-4 mb-6 md:flex-col">
                  ...
                  <div className={`w-full -mt-2  md:ml-[690px] md:flex-1 md:-mt-[250px]`}>
                    ...
                    <select
                      ...
                      className="w-[70px] md:w-[80px] bg-gray-50 border border-gray-300 text-gray-900 text-[10px] rounded-1xl focus:ring-black focus:border-black block w-full p-2.5 py-1.5 placeholder:text-[10px] pl-1 mt-1"
                    >
                    ...
                    <select
                      ...
                      // className="w-[82px] h-[25px] ml-[70px] text-gray-900 text-[12px] bg-gray-200"
                      className="w-[70px] md:w-[80px] bg-gray-50 border border-gray-300 text-gray-900 text-[10px] rounded-1xl focus:ring-black focus:border-black block w-full p-2.5 py-1.5 placeholder:text-[10px] pl-1 -mt-[27px] ml-[100px] md:ml-[85px]"
                    >
                    ...
                    <select
                      ...
                      // className="w-[82px] h-[25px] ml-[70px] text-gray-900 text-[12px] bg-gray-200"
                      className="w-[70px] md:w-[80px] bg-gray-50 border border-gray-300 text-gray-900 text-[10px] rounded-1xl focus:ring-black focus:border-black block w-full p-2.5 py-1.5 placeholder:text-[10px] pl-1 -mt-[27px] ml-[200px] md:ml-[170px]"
                    >
